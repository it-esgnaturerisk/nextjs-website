...
export default function SiteRange({ onRangeUpdate }: { onRangeUpdate: (selectedValues: number[]) => void }) {
  const options = [
    { value: 1, label: '1 km' },
    { value: 2, label: '2 km' },
    { value: 3, label: '3 km' },
  ...
  return (
    <div className="mb-6">
      <label className="block text-gray-700 font-semibold mb-2" htmlFor="longitude">
        Ranges*
      </label>
      <p className="text-sm text-gray-500 mb-2">
        Select up to three ranges (radius) to calculate and assess risks around the central point.
      </p>
      <Select
