...
import { updateSpeciesMarkedIrrelevant } from '@/lib/db/queries';
...
export default function DataTableSpecies({
  data,
  ...
  const processSelectedSpecies = useCallback(
  ...
  const handleDelete = useCallback(() => {
    processSelectedSpecies(updateSpeciesMarkedIrrelevant, '{count} species deleted!');
    setSelectedRows([]);
  }, [processSelectedSpecies]);
